...
import com.example.assignmentimageapp.screen.MainScreen
import com.example.assignmentimageapp.ui.theme.AssignmentImageAppTheme
...
class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
       ...
       val bitmapLruCache= BitmapLruCache()
        setContent {
            AssignmentImageAppTheme {
                // A surface container using the 'background' color from the theme
                Surface(
                    modifier = Modifier.fillMaxSize(),
                    color = MaterialTheme.colorScheme.background
                ) {
                    MainScreen(bitmapLruCache=bitmapLruCache)
                }
            }
        }
    }
